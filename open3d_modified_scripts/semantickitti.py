...
class SemanticKITTI(BaseDataset):
    ...
    def get_label_to_names():
        ...
        label_to_names = {
            ...
            4: 'Fixed_obstacles',
            5: 'Temporary_Ramps',
            6: 'Safety_Barriers_and_Signs',
            7: 'Temporary_Utilities',
            8: 'Scaffold_Structure',
            9: 'Semi_fixed_obstacles',
            10: 'Large_Materials',
            11: 'Stored_Equipment',
            12: 'Mobile_Machines_and_Vehicles',
            13: 'Movable_Objects',
            14: 'Containers_and_Pallets',
            15: 'Small_Tools',
            16: 'Debris_and_Loose_packaging',
            17: 'Portable_objects',
            18: 'Unclassified_Items',
        }
    ...
    def is_tested(self, attr):
        ...
        cfg = self.cfg
        name = attr['name']
        name_seq, name_points = name.split("_",1)
